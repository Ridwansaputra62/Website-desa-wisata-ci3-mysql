...
<section id="hero-animated" class="hero-animated" style="background: url('<?= $bg_url ?>') center center / cover no-repeat;">
  ...
  <div class="container">
    <h1>Cost Estimasi</h1>
    <p>Hitung estimasi biaya wisata Anda dengan mudah dan akurat</p>
    <!-- Ikon Scroll -->
    <div class="scroll-down">
  <a class="scroll-down" href="<?= base_url('cost_estimasi#cost-estimasi-section'); ?>" aria-label="Scroll ke bagian tentang">
