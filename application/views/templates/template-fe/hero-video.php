...
<section id="hero-animated" class="hero-animated" style="background: url('<?= $bg_url ?>') center center / cover no-repeat;">
  ...
  <div class="container">
    ...
    <p>Temukan informasi menarik seputar wisata dan traveling di Desa Wisata Sedari</p>

    <form action="<?= base_url('blog/search'); ?>" method="GET" class="search-box position-relative">
  ...
  <a class="scroll-down" href="<?= base_url('blog#blog-section'); ?>" aria-label="Scroll ke bagian tentang">
