...
<section id="hero-animated" class="hero-animated" style="background: url('<?= $bg_url ?>') center center / cover no-repeat;">
  ...
  <div class="container">
    <h1>Jelajahi Wisata Kami</h1>
    <p>Temukan pengalaman tak terlupakan di Desa Wisata Sedari</p>
 

    <!-- Ikon Scroll -->
    <div class="scroll-down">
  <a class="scroll-down" href="<?= base_url('wisata#wisata-section'); ?>" aria-label="Scroll ke bagian tentang">
