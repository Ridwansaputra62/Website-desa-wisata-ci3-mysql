...
<section id="hero-animated" class="hero-animated" style="background: url('<?= $bg_url ?>') center center / cover no-repeat;">
  ...
  <div class="container">
    <h1>Galeri Wisata</h1>
    <p>Jelajahi keindahan setiap wisata melalui foto dan video</p>

    <!-- Ikon Scroll -->
    <div class="scroll-down">
  <a class="scroll-down" href="<?= base_url('galeri#galeri-section'); ?>" aria-label="Scroll ke bagian tentang">
