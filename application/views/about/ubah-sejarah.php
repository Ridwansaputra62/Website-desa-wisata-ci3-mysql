<!-- ============================================================== -->
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Update Sejarah</h4>
            ...
            <?php foreach ($sejarah as $s) { ?>
                            <form class="form-horizontal" action="<?=base_url('sejarah/ubahSejarah'); ?>" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <textarea class="form-control" id="falamat" name="keterangan" value="<?= $s['keterangan']; ?>" placeholder="Edit Alamat" rows=20></textarea>
                                        </div>
                                    </div>
                                </div>
